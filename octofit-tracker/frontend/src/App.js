    ...
    <Router>
      <div className="container mt-4">
        ...
        <Routes>
          ...
          <Route path="/" element={<div className="card p-4"><h1 className="display-4 text-primary">Welcome to Octofit Tracker!</h1><p className="lead">Track your fitness, join teams, and compete on the leaderboard.</p></div>} />
        </Routes>
      </div>
    </Router>
  );
